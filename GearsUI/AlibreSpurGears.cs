...
namespace GearsUI
{
    class AlibreSpurGears
    {
        public void Create(string name, SpurGearSetInfo gears, bool createGear1, bool createGear2, bool createMount)
        {
            ...
            if (createGear1) gear1 = CreateGear(assembly, "Gear1 M" + gears.module.ToString() + " T" + gears.gear1.teeth, gears.gear1.shapes, gears.gear1.teeth, gears.gear1.thickness, gears.gear1.boreDiameter);
            if (createGear2) gear2 = CreateGear(assembly, "Gear2 M" + gears.module.ToString() + " T" + gears.gear2.teeth, gears.gear2.shapes, gears.gear2.teeth, gears.gear2.thickness, gears.gear2.boreDiameter);
            if (createMount)
            {
        ...
        private IADOccurrence CreateGear(IADAssemblySession assembly, string name, List<Shape> shapes, int teeth, double thickness, double bore)
        {
            ...
            IADSketch sketch = part.Sketches.AddSketch(null, part.DesignPlanes.Item("XY-Plane"), "Involute Profile");
            ...
            sketch = part.Sketches.AddSketch(null, part.DesignPlanes.Item("XY-Plane"), "Bore");
            sketch.BeginChange();
            sketch.Figures.AddCircle(0, 0, MMToCM(bore / 2.0));
            sketch.EndChange();
